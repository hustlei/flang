// Lex/lexer.cpp generated by reflex 3.0.2 from Lex/lexer.l
...
#define REFLEX_OPTION_outfile             "Lex/lexer.cpp"
  ...
  while (true)
  {
        switch (matcher().scan())
        {
          case 0:
            ...
            YY_BREAK
          case 1: // rule Lex/lexer.l:16: [0-9]+ :
            YY_USER_ACTION
#line 16 "Lex/lexer.l"
{ yylval.string = new std::string(yytext, yyleng);return INTEGER; }
            YY_BREAK
          case 2: // rule Lex/lexer.l:17: [a-zA-Z]+ :
            YY_USER_ACTION
#line 17 "Lex/lexer.l"
{ TOKEN_WITHVAL(IDENTIFIER) }
            YY_BREAK
          case 3: // rule Lex/lexer.l:18: "=" :
            YY_USER_ACTION
#line 18 "Lex/lexer.l"
{ return TOKEN(ASSIGN); }
            YY_BREAK
          case 4: // rule Lex/lexer.l:19: "+" :
            YY_USER_ACTION
#line 19 "Lex/lexer.l"
{ return TOKEN(ADD); }
            YY_BREAK
          case 5: // rule Lex/lexer.l:20: "-" :
            YY_USER_ACTION
#line 20 "Lex/lexer.l"
{ return TOKEN(SUB); }
            YY_BREAK
          case 6: // rule Lex/lexer.l:21: "*" :
            YY_USER_ACTION
#line 21 "Lex/lexer.l"
{ return TOKEN(MUL); }
            YY_BREAK
          case 7: // rule Lex/lexer.l:22: "/" :
            YY_USER_ACTION
#line 22 "Lex/lexer.l"
{ return TOKEN(DIV); }
            YY_BREAK
          case 8: // rule Lex/lexer.l:23: [\r]|[\n]|[\r\n] :
            YY_USER_ACTION
#line 23 "Lex/lexer.l"
{ return TOKEN(EOL); }
            YY_BREAK
